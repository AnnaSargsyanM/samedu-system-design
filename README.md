...
![Controller Class Diagram](images/controller-class-diagram.png)

### Content Approval Activity Diagram

![Content Approval Activity Diagram](images/content-approval-activity.png)

### Content Sharing Sequence Diagram

![Content Sharing Sequence Diagram](images/content-sharing-sequence.png)

### Content Approval Sequence Diagram

![Content Approval Sequence Diagram](images/content-approval-sequence.png)
